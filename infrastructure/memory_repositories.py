from errors.custom_exceptions import RepositoryError
...
class Repository:
    ...
    @property
    def entities(self):
        # returns a copy of the entities list using slicing to prevent direct modification of the internal list
