...
from errors.custom_exceptions import ServiceError
...
class RentalService:
    ...
    @staticmethod
    def count_movie_passed_rental_delay_days(passed_rentals, movie_id):
        """
    ...
    @staticmethod
    def find_number_of_rental_days(number_of_rental_days, rental):
        """
